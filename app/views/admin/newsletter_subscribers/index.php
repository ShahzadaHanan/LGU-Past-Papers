...
<td><span class="badge <?= $s->is_verified ? 'badge-success' : 'badge-warning' ?>"><?= $s->is_verified ? 'Active' : 'Inactive' ?></span></td>
...
<?= \App\Helpers\Form::csrf($csrf) ?><button class="btn-secondary" type="submit"><?= $s->is_verified ? 'Deactivate' : 'Activate' ?></button></form>
