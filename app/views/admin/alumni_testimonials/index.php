...
<table><thead><tr><th>Photo</th><th>Name</th><th>Batch</th><th>Degree</th><th>Status</th><th>Actions</th></tr></thead><tbody>
<?php if (empty($items)): ?><tr><td colspan="6">No testimonials found.</td></tr><?php else: foreach ($items as $a): ?>
<tr>
...
<td><?= htmlspecialchars($a->batch_year, ENT_QUOTES, 'UTF-8') ?></td>
