<main class="container section">
    <h1 style="font-size: 2.5rem; font-weight: 800; color: var(--primary-color); margin-bottom: 30px; text-align: center;">
        About LGU Past Papers & Lectures Hub
    </h1>
    
    <div style="max-width: 800px; margin: 0 auto; display: flex; flex-direction: column; gap: 40px;">
        <?php if (empty($blocks)): ?>
            <div style="text-align: center; color: var(--text-muted);">
                <p>This portal is developed to assist LGU students in accessing past examinations, midterm solutions, and verified digital lectures systematically. All components are admin-managed dynamically.</p>
                <p style="margin-top: 15px;">Additional information blocks are managed in the administrator panel.</p>
            </div>
        <?php else: ?>
